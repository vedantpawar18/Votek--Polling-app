		...
		<>
			...
			>
				<Box
					...
					h={"300px"}
				>
					<Heading fontFamily={"Open Sans"} lineHeight={"100px"}>Interactive Live Polling</Heading>
					...
					<Button fontFamily={"Open Sans"} bgColor={"red"} color={"white"} mt={"2%"}>
						Show Poll
					</Button>
				</Box>
				<Box w={"50%"} h={"300px"}>
			...
			>
				<Box>
					...
					<Text fontFamily={"Open Sans"} fontWeight={"600"} fontSize={"17px"} fontStyle={"normal"}>
